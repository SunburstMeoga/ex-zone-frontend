    ...
    <div className="">
      ...
      <div className="join-gradient pt-3-9 h-auto">
        <div className="flex justify-start items-center flex-col mb-2-1 lg:justify-center ">
          <div className="w-21-6 text-3-0 font-semibold text-white line-height-point-107 mb-0-6 lg:text-6-0 lg:pt-6-3 lg:w-42-3 lg:text-center lg:mb-2-1"><span className="text-primary-purple">Join</span> Our<br></br><span className="text-primary-red">Community</span></div>
