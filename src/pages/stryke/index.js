            ...
            <div className='pt-5-0 bg-black text-white'>
                <div className='flex flex-col justify-start items-center w-full'>
                    ...
                    <div className='w-full flex flex-col justify-start items-center bg-white text-swap-border '>
                        ...
                        <div className='w-full overflow-x-scroll  text-swap-border'>
                            <div className='flex justify-start items-center text-swap-border text-0-7  pl-1-0 py-0-8 bg-setting-button font-medium'>
                            ...
                            {dataList.map((item, index) => {
                                return <div key={index} className='flex justify-start items-center text-swap-border text-0-7 py-1-0 border-b border-dashed border-voting-border pl-1-0 flex-1'>
                                    ...
                                    <div className='w-7-5 shrink-0'>
                                        ...
                                        <div className=''>2.6222  WETH</div>
                                    </div>
                                    <div className='w-7-5 shrink-0'>
                                        <div className='font-semibold'>0.000512</div>
                                        <div className=''>$ 9038.5512</div>
                                    </div>
                    ...
                    <div className='bg-syrup-module w-full pt-1-7 flex flex-col justify-start items-center'>
                        ...
                        <div className='w-22-0'>
                            <div className='w-full text-0-7 text-gray-500 font-semibold mb-1-0'>Expiry</div>
                            ...
                            <div className='w-full flex justify-between items-center text-gray-500 mb-1-0'>
                            ...
                            <div className='w-full mb-1-0'>
                                {strikesList.map((item, index) => {
                                    return <div key={index} className='flex justify-between items-center mb-0-6'>
                                        <div className='icon iconfont text-gray-500 icon-close'></div>
                                        ...
                                        <div className='flex justify-between items-center w-11-5 px-0-4  h-1-7 border border-pools-border rounded-lg text-gray-500 bg-futures-input-module text-0-7 font-medium'>
                            ...
                            <div className='w-full'>
                                <div className='flex justify-between items-center'>
                                    <div className='w-10-6 h-2-4 flex justify-center items-center text-white font-semibold text-0-8 rounded-lg bg-menu-green'>
                                        <div>0 Call strikes</div>
                                        <div className='icon iconfont icon-down1 text-1-4 ml-1-6'></div>
                                    </div>

                                    <div className='w-10-6 h-2-4 flex justify-center items-center text-white font-semibold text-0-8 rounded-lg bg-primary-red'>
                            ...
                            <div className='w-full border-b border-dashed border-voting-border my-1-0'></div>
                            <div className='w-full text-0-7 text-gray-500 font-semibold mb-1-0'>Auto Exercisers</div>
                            <div className='w-full flex justify-between items-center text-gray-500 mb-1-0'>
